...
namespace AeUI.PickerWheelUI
{
    ...
    public class PickerWheel : MonoBehaviour
    {
        ...
        [SerializeField] private Transform spinCircle;
        ...
        public WheelPiece[] zeroRiskWheelPieces;
        ...
        {
            if (Demo.instance.spinButtonCount==0)
            {
        ...
        private void DrawPiece(int index)
        {
            ...
            else if (Demo.instance.spinButtonCount % 5 == 0 && Demo.instance.spinButtonCount != 0)
            {
                WheelPiece piece = zeroRiskWheelPieces[index];
                Transform pieceTrns = spinCircle.GetChild(0).GetChild(0).transform;
        ...
        public void Spin()
        {
            if (!_isSpinning)
            {
                ...
                if (Demo.instance.spinButtonCount % 5 == 0 && Demo.instance.spinButtonCount != 0)
                {
                    WheelPiece piece = zeroRiskWheelPieces[index];
        ...
        public int GetRandomPieceIndex()
        {
            ...
            if (Demo.instance.spinButtonCount % 5 == 0 && Demo.instance.spinButtonCount != 0)
            {
                for (int i = 0; i < zeroRiskWheelPieces.Length; i++)
                    if (zeroRiskWheelPieces[i]._weight >= r)
                        return i;
        ...
        public void CalculateWeightsAndIndices()
        {
            if (Demo.instance.spinButtonCount % 5 == 0 && Demo.instance.spinButtonCount != 0)
            {
                for (int i = 0; i < zeroRiskWheelPieces.Length; i++)
                {
                    WheelPiece piece = zeroRiskWheelPieces[i];
